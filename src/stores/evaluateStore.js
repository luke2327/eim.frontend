...
export default class EnhanceStore {
  ...
  @action evaluateMainStatItem = () => {
    ...
    if (this.item.cate === 'equip') {
      maxStat = this.itemClass === 'daemon' ? 8000 : 450;
    ...
    console.log('전체스탯 : ', maxStat);
    console.log('현재스탯 : ', currentStat);
  ...
  @action evaluateItem = () => {
    ...
    console.log('추옵단계      DATA : ', this.evaluateData[0].A);
    console.log('주문서강화수치 DATA : ', this.evaluateData[1].A);
    console.log('시장가치      DATA : ', this.evaluateData[2].A);
    console.log('스타포스      DATA : ', this.evaluateData[3].A);
    console.log('총메인스탯    DATA : ', this.evaluateData[4].A);
  }
